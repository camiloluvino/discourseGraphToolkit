        ...
        const renderCLMBranch = (clmUid, allNodes, depth = 0) => {
            ...
            return React.createElement('div', {
                ...
                style: {
                    ...
                    marginTop: '0.25rem',
                    borderLeft: `2px solid ${DiscourseGraphToolkit.THEME?.colors?.success || '#4CAF50'}`,
                    paddingLeft: '0.5rem',
                    marginLeft: '0.25rem'
                }
            },
                ...
                React.createElement('div', {
                    ...
                    React.createElement('span', {
                        ...
                        style: {
                            color: DiscourseGraphToolkit.THEME?.colors?.successHover || '#2E7D32',
                            cursor: 'pointer',
                            fontSize: '0.75rem',
                            fontWeight: '500'
                        },
                ...
                clm.supporting_clms && clm.supporting_clms.length > 0 && React.createElement('div', {
                    style: { paddingLeft: '0.5rem' }
                },
                    clm.supporting_clms.slice(0, 2).map(suppUid =>
                        renderCLMBranch(suppUid, allNodes, depth + 1)
                    ),
                    clm.supporting_clms.length > 2 && React.createElement('div', {
                        style: { color: '#999', fontSize: '0.625rem', marginTop: '0.25rem' }
                    }, `+${clm.supporting_clms.length - 2} afirmaciones más`)
                )
            );
        };
        ...
        const renderQuestion = (question, allNodes) => {
            ...
            return React.createElement('div', {
                ...
                style: {
                    ...
                    padding: '0.75rem',
                    paddingLeft: '1rem',
                    borderLeft: `3px solid ${DiscourseGraphToolkit.THEME?.colors?.primary || '#2196F3'}`,
                    maxWidth: '1200px'
                }
            },
                ...
                React.createElement('div', {
                    ...
                    selectedProject && React.createElement('div', {
                        style: { display: 'flex', flexDirection: 'column', marginTop: '0.125rem' },
                    ...
                    React.createElement('span', { style: { color: '#9ca3af', fontSize: '0.6875rem', marginTop: '0.25rem' } },
                        isExpanded ? '▼' : '▶'),
                    React.createElement('div', { style: { flex: 1, paddingRight: '1rem' } },
                        React.createElement('span', {
                            onClick: (e) => { e.stopPropagation(); handleNavigateToPage(question.uid); },
                            style: {
                                color: DiscourseGraphToolkit.THEME?.colors?.primaryHover || '#1976D2',
                                fontWeight: 'bold',
                                fontSize: '0.875rem',
                                cursor: 'pointer',
                ...
                isExpanded && React.createElement('div', {
                    style: { paddingLeft: '1.25rem', marginTop: '0.75rem' }
                },
                    // CLMs
                    clms.map((clmUid, index) => renderCLMBranch(clmUid, allNodes)),

                    // EVDs directas
                    directEvds.length > 0 && React.createElement('div', { style: { marginTop: clms.length > 0 ? '0.5rem' : 0 } },
                    ...
                    totalBranches === 0 && React.createElement('div', {
                        style: { color: '#9ca3af', fontSize: '0.75rem', fontStyle: 'italic', marginTop: '0.5rem', marginLeft: '0.25rem' }
                    }, 'Sin respuestas')
                )
            );
        };
        ...
        return React.createElement('div', null,
            ...
            React.createElement('div', {
                ...
                React.createElement('div', {
                    ...
                    // Fila 2: Estadísticas y Botones expandir/colapsar
                    panoramicData && React.createElement('div', { style: { display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'flex-end' } },
                        // Cache info (si existe)
                        cacheTimestamp && !isLoading && React.createElement('div', {
                            ...
                            React.createElement('button', {
                                ...
                                style: {
                                    ...
                                    color: DiscourseGraphToolkit.THEME?.colors?.warning || '#ff9800',
                        ...
                        React.createElement('div', {
                            style: { display: 'flex', gap: '0.375rem', marginRight: '0.5rem' }
                        },
                            React.createElement('span', {
                                style: {
                                    padding: '0.125rem 0.375rem',
